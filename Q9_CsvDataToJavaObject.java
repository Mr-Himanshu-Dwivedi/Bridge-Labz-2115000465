...
public class Q9_CsvDataToJavaObject {
    ...
    private static void createCSVFile(String filePath) {
        ...
        if (!file.exists()) {
            try (PrintWriter writer = new PrintWriter(new FileWriter(filePath))) {
                ...
                writer.println("1,Himanshu,21,85");
                writer.println("2,Ayush,22,78");
                writer.println("3,Kartikey,23,90");
                writer.println("4,Krishna,22,88");
                writer.println("5,Rajat,20,75");
