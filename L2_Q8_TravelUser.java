...
public class L2_Q8_TravelUser {
    public static void main(String[] args) {
        ...
        // Create a variable fromCity, viaCity and toCity to indicate the city from city, via city and to city the person is travelling
        ...
        // Create a variable timeViaToFinalCity to indicate the time taken to travel from viaCity to toCity in minutesṣ
