    ...
    private static void createCSVFile(String filePath) {
        ...
        if (!file.exists()) {
            try (CSVWriter writer = new CSVWriter(new FileWriter(filePath))) {
                ...
                String[] emp1 = {"1", "Himanshu", "himanshu@gmail.com", "9876543210", "Engineering"};
                String[] emp2 = {"2", "Ayush", "ayush@company", "123456789", "IT"};
                String[] emp3 = {"3", "Kartikey", "kartikey554@email.com", "9123456789", "Marketing"};
                String[] emp4 = {"4", "Krishna", "krishna@", "98765432100", "IT"};
                String[] emp5 = {"5", "Rajat", "rajat@domain.com", "8527419630", "Finance"};
