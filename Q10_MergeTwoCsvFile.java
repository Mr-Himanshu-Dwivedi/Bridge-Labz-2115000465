    ...
    private static void createCSVFile1(String filePath) {
        ...
        if (!file.exists()) {
            try (PrintWriter writer = new PrintWriter(new FileWriter(filePath))) {
                ...
                writer.println("1,Himanshu,21");
                writer.println("2,Ayush,22");
                writer.println("3,Kartikey,23");
                writer.println("4,Krishna,22");
                writer.println("5,Rajat,20");
    ...
    private static void createCSVFile2(String filePath) {
        ...
        if (!file.exists()) {
            try (PrintWriter writer = new PrintWriter(new FileWriter(filePath))) {
                ...
                writer.println("2,78,B");
                writer.println("3,90,A+");
                writer.println("4,88,A");
                writer.println("5,75,C");
