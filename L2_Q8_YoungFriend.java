...
public class L2_Q8_YoungFriend {
    public static void main(String[] args) {
        ...
        System.out.printf("The youngest friend is: %s (Age: %d)",youngestFriend,youngestAge);
        System.out.printf("The tallest friend is: %s (Height: %.2f meters)",tallestFriend,tallestHeight);
    }
}
